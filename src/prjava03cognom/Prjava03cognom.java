...
public class Prjava03cognom extends Frame 
   ...
   public Prjava03cognom () { 
      ...
      setTitle("Nova finestra prjava03cognom");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03cognom();  // Let the construct do the job 
   } 
